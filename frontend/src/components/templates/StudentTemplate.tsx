...
const StudentTemplate: React.FC<TemplateProps> = ({ profile, customizations }) => {
  return (
    <div className="w-full bg-white p-10" style={{ fontFamily: 'Calibri, Arial, sans-serif', color: '#000000' }}>
      {/* Header */}
            ...
            <div key={idx} className="mb-4">
              ...
              {edu.relevantCoursework && (
                <p className="text-sm mt-1">
                  <span className="font-semibold">Relevant Coursework:</span> {edu.relevantCoursework}
                </p>
              )}
            </div>
          ))}
